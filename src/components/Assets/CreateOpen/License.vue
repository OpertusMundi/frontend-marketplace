        ...
        <div class="form-group">
          ...
          <label class="control control-radio" v-if="$store.getters.hasRole(['ROLE_SENTINEL_HUB'])">
            <div class="svg-label-container">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 20 20"><g id="Layer_1-2"><g><path fill="#333" d="M20,4.51l-3.25-3.16-3.37,3.27V0h-4.6V7.98c.27-.29,.6-.53,.98-.69,.12-.07,.23-.11,.37-.15,.25-.08,.52-.12,.79-.13,.05,0,.1,0,.15,0,.06,0,.12,0,.17,0,.31,0,.61,.08,.89,.18,.13,.04,.25,.09,.37,.15,.33,.17,.63,.39,.88,.66,.21,.22,.37,.47,.52,.73,.18,.35,.28,.73,.29,1.14,0,.05,0,.1,0,.15,0,.04,0,.09,0,.13-.02,.41-.12,.8-.29,1.15-.13,.28-.31,.53-.52,.75-.24,.26-.53,.48-.86,.65-.13,.06-.25,.12-.39,.16-.29,.11-.59,.17-.92,.18-.04,0-.09,0-.14,0-.04,0-.08,0-.13,0-.28,0-.56-.05-.82-.13l-.38-.15c-.37-.17-.7-.41-.97-.69v7.95h4.6v-4.62l3.37,3.27,3.25-3.15-5.66-5.5,5.66-5.49Zm-7.87,1.31c-.33-.09-.69-.13-1.06-.13-.33,0-.64,.03-.94,.1V1.37h2V5.82Zm0,12.83h-2v-4.41c.3,.07,.62,.1,.94,.1,.37,0,.72-.04,1.06-.13v4.44Zm1.35-12.27l3.23-3.13,1.42,1.37-3.25,3.15c-.34-.56-.82-1.04-1.4-1.39Zm1.41,5.88l3.24,3.14-1.42,1.37-3.23-3.12c.57-.35,1.05-.82,1.4-1.38Z"/><path fill="#333" d="M7.97,9.87s0,.09,0,.14c0,.04,0,.08,0,.13,0,.29,.07,.57,.16,.84v5.05l-2.72,2.63-3.25-3.15,3.37-3.27H0V7.78H5.53l-3.38-3.27,.21-.21L5.2,1.56l.21-.21,2.72,2.62v5.07c-.09,.26-.15,.54-.16,.82Z"/></g></g></svg>
