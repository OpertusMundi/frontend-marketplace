...
export default class HorizontalCard extends Vue {
  ...
  @Prop({ required: true }) readonly linkText!: string;

  @Prop({ required: true }) readonly topRight!: string;
